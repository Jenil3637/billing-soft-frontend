...
const Sidebar = () => {
  ...
  // Updated MobileMenuButton with better visibility classes
  ...
  const SidebarContent = () => (
    ...
    <div className={`p-5 ${isExpanded ? 'px-6' : 'px-4'}`}>
      ...
      <div className={`p-4 ${isExpanded ? 'px-6' : 'px-4'} mt-auto`}>
        <div className={`
          py-2 px-3 bg-blue-900/30 rounded-lg text-white text-sm
    ...
    <>
      ...
      <div 
        className={`
          ...
          h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-blue-900
